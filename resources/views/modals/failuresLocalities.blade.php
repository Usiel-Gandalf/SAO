        ...
        <div class="modal-content p-1">
            <div class="row justify-content-md-center">
                <div class="col-11">
                    <ul>
                        <li>
                            <strong>TODAS LAS FILAS QUE NO APARECEN EN EL REPORTE SE REGISTRARAN SIN PROBLEMA ALGUNO</strong>
                        </li>
                        <li>
                        ...
                        <li>
                            <p>Si el error es un mensaje similar a este: <strong>The claveofi has already been taken.</strong> significa que el registro ya existe y
