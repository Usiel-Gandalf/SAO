...
<center>
    ...
    {{$municipality->region->nameRegion}} | {{$municipality->region->id}} | {{$municipality->region->region}} |
    ...
    <table class="table table-bordered text-center">
        <thead class="thead-light">
            <tr>
                @foreach($municipalityInfo as $municipality)
                <td scope="col">
                    <h6><b>MUNICIPIO:</b> {{$municipality->nameMunicipality}}</h6>
                </td>
                <td scope="col">
                    <h6><b>NUMERO:</b> {{$municipality->id}}</h6>
                </td>
                @endforeach
            </tr>
        </thead>
