                ...
                <div class="card text-center shadow-lg p-3 mb-5 bg-white rounded border-primary">
                    <div class="card-header">
                        <ul class="nav nav-pills card-header-pills">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('editAdminPassword') }}" tabindex="-1"
                                    aria-disabled="true">CAMBIAR CONTRASEÑA</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('editAdminEmail') }}" tabindex="-1"
                                    aria-disabled="true">CAMBIAR CORREO</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="container border-danger">
                            <form action="{{ url('/editAdminPassword/' . $idAdmin . '/updateAdminPassword') }}"
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" name="password_confirmation"
                                                id="password_confirmation" placeholder="Confrimar la nueva contraseña">
                                        </div>
                                    </div>
                                </div>
